...
namespace QLTV.Control
{
    public partial class Usc_TraCuuTheoTheloai_TuaSach : UserControl
    {
        ...
        private void btnXoaTL_Click(object sender, EventArgs e)
        {
            if (txtMaTheLoai.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Mã thể loại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMaTheLoai.Focus();
                return;
            }
        ...
        private void btnCapNhatTL_Click(object sender, EventArgs e)
        {
            if (txtMaTheLoai.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Mã  thể loại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMaTheLoai.Focus();
                return;
            }
            if (txtTenTheLoai.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Tên thể loại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtTenTheLoai.Focus();
                return;
            }
